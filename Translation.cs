...
namespace Desfribalator
{
    ...
    {
        public string MessageWhenYouRevive { get; private set; } =
            "You feel like you recover your life\n<color=#028EDC>{PlayerName} has revived you with a defibrillator!</color>";
        ...
        public string MessageWhenYouReviveSCP { get; private set; } =
            "<color=red>Someone make the error of reviving You...</color>\n<color=#028EDC>{PlayerName} has revived you with a defibrillator!</color>";

        public string BlacklistedSCPMessage { get; private set; } =
            "You can't revive something like that\n<color=red>Maybe you can revive other SCPs...</color>";

        public string MessageWhenARagdollnotavailable { get; private set; } =
            "This body has not a soul anymore...\n<color=red>You shouldn't try again</color>";
